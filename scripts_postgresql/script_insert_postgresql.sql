...
INSERT INTO produto (idCategoria, nome, classificacaoInfantil, avaliacao, dimensoes)
	VALUES	(6, 'Notebook Lenovo', DEFAULT, DEFAULT, null),
            ...
            (1, 'Aimone Vinho Rosso d’Italia', TRUE, 3, null),
            (3, 'Biscoito Recheado (64 UNID) Visconti 125g', DEFAULT, DEFAULT, null),
            (2, 'Anel Malone Dourado', TRUE, 2.7, null),
            (4, 'Raquete de Beach Tennis Heroes Omnia', TRUE, 4.1, '50 x 20'),
            (1, 'Whisky Johnnie Walker Red Label 1L', TRUE, DEFAULT, null),
            (5, 'Escrivaninha Mesa para Computador Dubai Multimóveis Branca/rustic', TRUE, 1.5, '121,5 x 90 x 45'),
            (6, 'SAMSUNG, Tablet Samsung Galaxy A7 Lite WiFi', TRUE, 4.7, '21.2 x 12.4 x 5.8 cm'),
            (4, 'Saco de Boxe Profissional Rhino by Spank', TRUE, DEFAULT, '90 x 90 x 70 cm'),
            (4, 'Kit com Barras de Halteres e Anilhas de Ferro Fundido - 12 Kg', TRUE, DEFAULT, '45 x 25 x 25 cm'),
