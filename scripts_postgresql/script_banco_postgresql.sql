...
CREATE TYPE TIPO_SITUACAO_PEDIDO AS ENUM ('Em processamento', 'Processando', 'Enviado', 'Entregue');

-- Cria a tabela de Pedido
CREATE TABLE pedido (
	idPedido SERIAL,
    situacao TIPO_SITUACAO_PEDIDO DEFAULT 'Em processamento',
...
-- Cria o tipo enum tipo_situacao
CREATE TYPE TIPO_SITUACAO_PRODUTO_PEDIDO AS ENUM ('Disponível', 'Sem estoque');
...
CREATE TABLE produto_pedido (
    ...
    quantidade INT DEFAULT 1,
    situacao TIPO_SITUACAO_PRODUTO_PEDIDO DEFAULT 'Disponível',
